...
import com.odeyalo.netflix.emailsenderservice.service.html.AdvancedHtmlTemplateProviderFactory;
import com.odeyalo.netflix.emailsenderservice.service.html.DynamicHtmlTemplateProvider;
...
public class DynamicTemplatedEmailMessageDTOKafkaMessageListener implements KafkaMessageListener<DynamicTemplatedEmailMessageDTO> {
    ...
    private final AdvancedHtmlTemplateProviderFactory factory;
    private final MimeMessageBuilder builder;

    @Autowired
    public DynamicTemplatedEmailMessageDTOKafkaMessageListener(IncomingEmailMessageCachingService cachingService, AdvancedHtmlTemplateProviderFactory factory, MimeMessageBuilder builder) {
    ...
    public void listen(DynamicTemplatedEmailMessageDTO dto) throws Exception {
        ...
        DynamicHtmlTemplateProvider template = factory.getDynamicHtmlTemplate(templateType);
